...
import { DELETE_EXPENSE } from '../graphql/mutations/expense.mutations';
...
const Card = ({ expenseData }) => {
  ...
  const handleDelete = async () => {
    console.log('The expense Id: ', expenseData._id);
    try {
      await deleteExpense({
        variables: { expenseId: expenseData._id },
      });
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-row items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to={`/expense/${expenseData._id}`}>
